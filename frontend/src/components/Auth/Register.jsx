...
export default function Register() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col font-sans selection:bg-primary/30 relative overflow-hidden">
      ...
      {/* Repeating tech grid lines and dots */}
      ...
      <div className="absolute top-[10%] right-[-15%] w-[500px] h-[500px] bg-primary/4 blur-[120px] rounded-full pointer-events-none -z-10 animate-orb-float"></div>
      <div className="absolute bottom-[10%] left-[-15%] w-[500px] h-[500px] bg-primary/3 blur-[120px] rounded-full pointer-events-none -z-10 animate-orb-float" style={{ animationDelay: '-6s' }}></div>
          ...
          <div className="glass-card rounded-3xl p-8 relative overflow-hidden glass-card-stroke tech-corners">
            ...
            <div className="mb-6 text-center sm:text-left">
              ...
              <p className="text-sm text-on-surface-variant mt-2">
                Join HabitForge and build clean developer habits.
              </p>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                {/* Password Strength Indicator (Static Placeholder UI) */}
                <div className="pt-1.5 space-y-1">
                  <div className="flex justify-between items-center text-[10px] font-semibold">
                    <span className="text-on-surface-variant/70">Password Security:</span>
                    <span className="text-on-surface-variant/40">Enter Password</span>
                  </div>
                  <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden flex gap-0.5">
                    <div className="h-full flex-grow rounded-full bg-white/10"></div>
                    <div className="h-full flex-grow rounded-full bg-white/10"></div>
                    <div className="h-full flex-grow rounded-full bg-white/10"></div>
                  </div>
                </div>
              ...
              <div className="flex items-start pt-1">
                <input
                  id="accept-terms"
                  type="checkbox"
                  className="mt-0.5 w-4 h-4 bg-black/30 border border-white/10 rounded accent-primary text-primary focus:ring-0 focus:ring-offset-0 cursor-pointer"
                />
                <label
                  htmlFor="accept-terms"
                  className="ml-2.5 text-xs text-on-surface-variant select-none leading-tight"
                >
                  I accept the{' '}
                  <a href="#" className="text-primary/80 hover:text-primary hover:underline font-semibold">Terms of Service</a>
                  {' '}and{' '}
                  <a href="#" className="text-primary/80 hover:text-primary hover:underline font-semibold">Privacy Policy</a>.
                </label>
              </div>
