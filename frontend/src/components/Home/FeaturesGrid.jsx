...
export default function FeaturesGrid() {
  return (
    <section className="py-24 px-8 max-w-7xl mx-auto border-t border-white/5" id="features">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
        ...
        <div className="md:col-span-7 glass-card p-8 rounded-2xl flex flex-col justify-between glass-card-stroke group relative overflow-hidden tech-corners">
        ...
        {/* Card 2: Interactive Heatmap summary */}
        <div className="md:col-span-5 glass-card p-8 rounded-2xl flex flex-col justify-between glass-card-stroke relative overflow-hidden tech-corners">
          <div className="tech-corner-tl"></div>
          <div className="tech-corner-tr"></div>
          <div className="tech-corner-bl"></div>
          <div className="tech-corner-br"></div>
          ...
          <div className="grid grid-cols-7 gap-1 mt-8 max-w-[180px]">
            {Array.from({ length: 14 }).map((_, idx) => {
              const colors = ['bg-neutral-900', 'bg-[#166534]', 'bg-primary'];
        ...
        <div className="md:col-span-5 glass-card p-8 rounded-2xl flex flex-col justify-between glass-card-stroke tech-corners">
          <div className="tech-corner-tl"></div>
          <div className="tech-corner-tr"></div>
          <div className="tech-corner-bl"></div>
          <div className="tech-corner-br"></div>
          ...
          <div className="mt-8 bg-white/2 border border-white/5 rounded-xl p-4 flex items-center justify-between">
            <div>
        ...
        <div className="md:col-span-7 glass-card p-8 rounded-2xl flex flex-col justify-between glass-card-stroke group tech-corners">
          <div className="tech-corner-tl"></div>
          <div className="tech-corner-tr"></div>
          <div className="tech-corner-bl"></div>
          <div className="tech-corner-br"></div>
          <div className="space-y-4">
            <div className="w-10 h-10 rounded-lg bg-blue-400/15 text-blue-400 flex items-center justify-center">
          ...
          <div className="mt-8 flex gap-1.5 self-end">
            {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((d, idx) => (
              <div key={idx} className="w-8 h-8 rounded-full border border-white/5 flex items-center justify-center text-[10px] text-white/20 font-mono">
                {d}
              </div>
            ))}
          </div>
