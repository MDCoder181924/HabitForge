...
export default function StayDisciplinedCard() {
  return (
    <div className="relative h-44 rounded-2xl overflow-hidden border border-white/5 group">
      <div className="absolute inset-0 bg-gradient-to-r from-black via-black/80 to-transparent z-10" />
      <img 
        className="absolute inset-0 w-full h-full object-cover mix-blend-luminosity opacity-40 group-hover:scale-105 transition-transform duration-700" 
      ...
      <div className="absolute inset-0 z-20 p-6 flex flex-col justify-end">
        <h4 className="text-white font-bold text-lg tracking-wider uppercase font-display">
          Stay Disciplined.
        </h4>
